...
export default function Banner({ section, title, subtitle }) {
    return (
        <div className="h-screen bg-slate-800 text-slate-100">
            <div className="flex flex-col items-center justify-center h-full px-8 xl:px-32">
                <motion.div className="flex flex-col justify-center items-center w-full max-w-7xl px-8 xl:px-32 py-16 bg-purple-200 text-slate-900 rounded-xl"
                    initial="hidden"
                    whileInView="visible"
                    viewport={{ once: true }}
                    transition={spring}

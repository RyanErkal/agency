...
export default function Services() {
    return (
        <div id="services" className="flex flex-col items-center justify-center bg-slate-800 text-slate-100 p-32 h-screen">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 max-w-7xl">
                <motion.div
                    ...
                    <Service
                        ...
                        description="Digital solutions that elevate your brand and drive revenues"
                        link="/web-dev"
                ...
                <motion.div
                    ...
                    <Service
                        ...
                        description="Cutting edge strategies that drive growth at start-up speed."
                        link="/lead-gen"
                ...
                <motion.div
                    ...
                    <Service
                        ...
                        description="Automate tasks to streamline workflow and reduce errors."
                        link="/business-ai"

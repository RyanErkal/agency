...
export default function About() {
    return (
        <div className="flex flex-col items-center justify-center bg-slate-800 text-slate-100 px-8 py-32 xl:px-32 h-screen">
            ...
            <motion.div
                ...
                <div className="w-full max-w-7xl">
                    <div className="border-2 border-purple-200 text-slate-100 p-8 flex flex-col items-start justify-between rounded-lg">
                        <div className="flex flex-col xl:flex-row justify-between items-center w-full h-min">
                            <div>
                                <h1 className="font-bold text-3xl">Ryan Erkal</h1>
                                <p className="text-md text-left mt-2">Design & Development
                                </p>
                            </div>
                            <div className="flex items-center justify-center text-purple-200 mt-2">
                                ...
                                <span className="text-slate-100 text-sm">Manchester</span>
                            </div>
                        </div>
                        <div className="mt-6 flex justify-between items-center w-full">
                            <a href="https://calendly.com/ryanerkal/ryan-erkal-consultation-call" target="_blank" rel="noreferrer" className="bg-purple-200 text-slate-900 border-2 font-bold text-xs xl:text-sm px-3 py-1.5 xl:px-6 xl:py-4 rounded-full hover:bg-slate-800 hover:border-purple-200 hover:text-purple-200 transition ease-in-out duration-300 flex items-center gap-2">

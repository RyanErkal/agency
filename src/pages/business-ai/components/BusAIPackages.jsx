...
export default function LeadGenPackages() {
    return (
        <div className="bg-slate-800 text-slate-100 w-full flex flex-col items-center justify-center px-8 py-32 xl:px-32">
            <h1 className="text-4xl font-bold playfair mb-6">Business AI Packages</h1>
